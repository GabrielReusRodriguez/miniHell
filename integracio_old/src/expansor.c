...
/*
	Here we expand the token,
		if we  found single quote , we do not expand anything
		else we expand the variables begining by $
	We do this way because we can find a token :
